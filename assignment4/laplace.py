...
def accuracy(e=0.5, n=10000, beta=0.05, query=counting_query):
    ...
    calculated_beta = 1.0 * error_points / iterations
    print(error_points, n)
    print(calculated_beta)
    return error, calculated_beta, alpha
    # i = plt.figure(3)
